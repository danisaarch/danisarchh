...
func LihatInformasiPengguna() {
	...
	fmt.Println("Username             	: Danisa")
	fmt.Println("Password               : 2406356624")
	fmt.Println("Jenis Kelamin        	: Perempuan")
	fmt.Println("Makanan Favorit        : Pie susu")
	fmt.Println("Minuman Favorit		: Milo")
	fmt.Println("==================================")
}
...
func main() {
	...
	var pengguna = Pengguna{"Danisa", "2406356624"}
